  ...
  const handleSubmit = async (e?: React.FormEvent, statusToSave?: string) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errJson.error || 'Terjadi kesalahan saat menyimpan artikel.');
      }
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between items-center mb-1">
                    <label className="text-[13px] font-semibold text-[#1d2327]">Judul Pos</label>
                ...
                <div className="pt-4 border-t border-[#f0f0f1] space-y-4">
        ...
        <div className="space-y-5">
          <div className="bg-white border border-[#c3c4c7] rounded-sm">
            ...
            <div className="p-3 bg-[#f6f7f7] flex justify-between items-center flex-wrap gap-2">
              <button type="button" onClick={() => navigate('/admin/posts')} className="text-[#d63638] text-[13px] hover:underline">Pindah ke Tong Sampah</button>
            ...
            <div className="p-4 text-[13px]">
              {formData.featuredImage ? (
                <div className="relative mb-3 group">
                  <img src={formData.featuredImage} alt="Thumbnail preview" className="w-full h-auto max-h-48 object-contain bg-[#f0f0f1]" />
                  <button type="button" onClick={() => setFormData({...formData, featuredImage: ''})} className="absolute top-2 right-2 bg-white rounded-sm px-2 py-1 opacity-0 group-hover:opacity-100 border border-[#d63638] text-[#d63638] transition text-[12px]">Hapus</button>
                </div>
              ) : (
